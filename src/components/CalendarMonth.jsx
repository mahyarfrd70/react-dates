      ...
      >
        ...
        <table
          {...css(
            ...
            verticalBorderSpacing && {
              borderSpacing: `0px ${verticalBorderSpacing}px`,
            }
          )}
          role="presentation"
        >
              ...
              <CalendarWeek key={i}>
                {week.map((day, dayOfWeek) =>
                  renderCalendarDay({
                    ...
                    isOutsideDay:
                      !day ||
                      momentJalaali(day).startOf("jMonth").format("jMM") !==
                        momentJalaali(month).startOf("jMonth").format("jMM"),
